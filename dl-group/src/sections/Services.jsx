...
const services = [
  { title: "Automação com N8N", description: "Conectamos suas ferramentas e criamos fluxos inteligentes.", icon: Zap, className: "md:col-span-2 bg-gradient-to-br from-blue-600/20 to-transparent" },
